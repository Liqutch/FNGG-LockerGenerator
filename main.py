...
os.system(f'TITLE FNGG-LockerGenerator v{__version__} by Liqutch')
...
class Generator:
    def __init__(self) -> None:
        ...
        self.access_token = ""
        self.user_agent = f"FNGG-LockerGenerator/{__version__} {platform.system()}/{platform.version()}"
    ...
    async def start(self) -> None:
        ...
        if not answers['start']:
            log.info(f'Closing FNGG-LockerGenerator v{__version__}...')
